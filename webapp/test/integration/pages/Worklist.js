sap.ui.define([
		...
		"com/evorait/evolite/evonotify/test/integration/pages/shareOptions"
			...
			onTheWorklistPage : {
				...
				assertions: jQuery.extend({
					...
					theTableShouldHaveAllEntries : function () {
						...
						// retrieve all PMNotifications to be able to check for the total amount
						this.waitFor(this.createAWaitForAnEntitySet({
							entitySet: "PMNotifications",
